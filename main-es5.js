...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _service_data_handler_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./service/data-handler.service */
    "./src/app/service/data-handler.service.ts");
    /* harmony import */


    var _service_intro_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var _views_header_header_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./views/header/header.component */
    "./src/app/views/header/header.component.ts");
    /* harmony import */


    var _views_stats_stats_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./views/stats/stats.component */
    "./src/app/views/stats/stats.component.ts");
    /* harmony import */


    var _views_tasks_tasks_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.dataHandler.getAllCategories().subscribe(function (categories) {
            return _this.categories = categories;
          });
          this.dataHandler.getAllPriorities().subscribe(function (priorities) {
            return _this.priorities = priorities;
          });
        ...
        value: function onUpdateTask(task) {
          ...
          this.dataHandler.updateTask(task).subscribe(function () {
            _this2.fillCategories();

            _this2.updateTasksAndStat();
          });
        }
      }, {
        key: "onDeleteTask",
        value: function onDeleteTask(task) {
          ...
          this.dataHandler.deleteTask(task.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["concatMap"])(function (t) {
            return _this3.dataHandler.getUncompletedTasksCountInCategory(t.category).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (count) {
              return {
                t: task,
                count: count
              };
            ...
            if (t.category) {
              _this3.categoryMap.set(t.category, result.count);
            }

            _this3.updateTasksAndStat();
          });
        }
      }, {
        ...
        value: function onDeleteCategory(category) {
          ...
          this.dataHandler.deleteCategory(category.id).subscribe(function () {
            _this4.selectedCategory = null;

            _this4.onSelectCategory(_this4.selectedCategory);

            _this4.categoryMap["delete"](category);
        ...
        value: function onUpdateCategory(category) {
          var _this5 = this;

          this.dataHandler.updateCategory(category).subscribe(function () {
            _this5.onSearchCategory(_this5.searchCategoryText);
          });
        }
      }, {
        key: "onFilterTasksByStatus",
        value: function onFilterTasksByStatus(status) {
          this.statusFilter = status;
          this.updateTasks();
        }
      }, {
        key: "onSearchTasks",
        value: function onSearchTasks(searchString) {
        ...
        value: function updateTasks() {
          ...
          this.dataHandler.searchTasks(this.selectedCategory, this.searchTaskText, this.statusFilter, this.priorityFilter).subscribe(function (tasks) {
            _this6.tasks = tasks;
          });
        }
      }, {
        key: "onFilterTasksByPriority",
        value: function onFilterTasksByPriority(priority) {
          this.priorityFilter = priority;
          this.updateTasks();
        }
      }, {
        key: "onAddTask",
        value: function onAddTask(task) {
          var _this7 = this;

          this.dataHandler.addTask(task).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["concatMap"])(function (t) {
            return _this7.dataHandler.getUncompletedTasksCountInCategory(t.category).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (count) {
              return {
                t: task,
                count: count
              };
            ...
            if (t.category) {
              _this7.categoryMap.set(t.category, result.count);
            }

            _this7.updateTasksAndStat();
          });
        }
      }, {
        key: "onAddCategory",
        value: function onAddCategory(title) {
          var _this8 = this;

          this.dataHandler.addCategory(title).subscribe(function () {
            return _this8.updateCategories();
          });
        }
      }, {
        ...
        key: "onSearchCategory",
        value: function onSearchCategory(title) {
          var _this10 = this;
        ...
        key: "updateTasksAndStat",
        value: function updateTasksAndStat() {
          this.updateTasks();
          this.updateStat();
        }
      }, {
        key: "updateStat",
        value: function updateStat() {
          var _this11 = this;

          Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["zip"])(this.dataHandler.getTotalCountInCategory(this.selectedCategory), this.dataHandler.getCompletedTasksCountInCategory(this.selectedCategory), this.dataHandler.getUncompletedTasksCountInCategory(this.selectedCategory), this.dataHandler.getUncompletedTotalCount()).subscribe(function (array) {
            _this11.totalTasksCountInCategory = array[0];
            _this11.completedTasksCountInCategory = array[1];
            _this11.uncompletedTasksCountInCategory = array[2];
            _this11.uncompletedTotalTasksCount = array[3];
          });
        }
      }, {
        key: "toggleStat",
        value: function toggleStat(showStat) {
        ...
        value: function fillCategories() {
          ...
          this.categories.forEach(function (cat) {
            _this12.dataHandler.getUncompletedTasksCountInCategory(cat).subscribe(function (count) {
              return _this12.categoryMap.set(cat, count);
            });
          });
        }
      }]);
    ...
    AppComponent.ɵfac = function AppComponent_Factory(t) {
      return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_data_handler_service__WEBPACK_IMPORTED_MODULE_3__["DataHandlerService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_intro_service__WEBPACK_IMPORTED_MODULE_4__["IntroService"]));
    };
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 14,
      vars: 13,
      consts: [[1, "wrapper"], ["data-color", "purple", "data-intro", "\u0414\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u0435, \u0443\u0434\u0430\u043B\u0435\u043D\u0438\u0435, \u0440\u0435\u0434\u0430\u043A\u0442\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u0435 \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u0439", "data-position", "right", "data-step", "1", 1, "sidebar"], [3, "categories", "selectedCategory", "categoryMap", "uncompletedTotal", "selectCategory", "deleteCategory", "updateCategory", "addCategory", "searchCategory"], [1, "main-panel"], [1, "navbar", "navbar-expand-lg", "navbar-transparent", "navbar-absolute", "fixed-top"], [3, "categoryName", "showStat", "toggleStat"], [1, "content"], [1, "container-fluid"], ["data-intro", "\u0421\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043A\u0430 \u043F\u043E \u0437\u0430\u0434\u0430\u0447\u0430\u043C", "data-position", "top", "data-step", "3"], [3, "totalTasksInCategory", "completedTasksInCategory", "uncompletedTasksInCategory", "showStat"], [1, "row"], [1, "col-12"], ["data-intro", "\u0421\u043F\u0438\u0441\u043E\u043A \u0437\u0430\u0434\u0430\u0447 \u0441 \u0432\u043E\u0437\u043C\u043E\u0436\u043D\u043E\u0441\u0442\u044C\u044E \u0438\u0445 \u0440\u0435\u0434\u0430\u043A\u0442\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u044F, \u0443\u0434\u0430\u043B\u0435\u043D\u0438\u044F \u0438 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u044F, \u0444\u0438\u043B\u044C\u0442\u0440\u0430\u0446\u0438\u0438 \u0438 \u0441\u043E\u0440\u0442\u0438\u0440\u043E\u0432\u043A\u0438 ", "data-position", "top", "data-step", "2"], [3, "tasks", "priorities", "selectedCategory", "updateTask", "deleteTask", "selectCategory", "addTask", "filterByStatus", "filterByTitle", "filterByPriority"]],
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectCategory", function AppComponent_Template_app_categories_selectCategory_2_listener($event) {
            return ctx.onSelectCategory($event);
          })("deleteCategory", function AppComponent_Template_app_categories_deleteCategory_2_listener($event) {
            return ctx.onDeleteCategory($event);
          })("updateCategory", function AppComponent_Template_app_categories_updateCategory_2_listener($event) {
            return ctx.onUpdateCategory($event);
          })("addCategory", function AppComponent_Template_app_categories_addCategory_2_listener($event) {
            return ctx.onAddCategory($event);
          })("searchCategory", function AppComponent_Template_app_categories_searchCategory_2_listener($event) {
            return ctx.onSearchCategory($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("toggleStat", function AppComponent_Template_app_header_toggleStat_5_listener($event) {
            return ctx.toggleStat($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("updateTask", function AppComponent_Template_app_tasks_updateTask_13_listener($event) {
            return ctx.onUpdateTask($event);
          })("deleteTask", function AppComponent_Template_app_tasks_deleteTask_13_listener($event) {
            return ctx.onDeleteTask($event);
          })("selectCategory", function AppComponent_Template_app_tasks_selectCategory_13_listener($event) {
            return ctx.onSelectCategory($event);
          })("addTask", function AppComponent_Template_app_tasks_addTask_13_listener($event) {
            return ctx.onAddTask($event);
          })("filterByStatus", function AppComponent_Template_app_tasks_filterByStatus_13_listener($event) {
            return ctx.onFilterTasksByStatus($event);
          })("filterByTitle", function AppComponent_Template_app_tasks_filterByTitle_13_listener($event) {
            return ctx.onSearchTasks($event);
          })("filterByPriority", function AppComponent_Template_app_tasks_filterByPriority_13_listener($event) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
        ...
        return [{
          ...
          type: _service_intro_service__WEBPACK_IMPORTED_MODULE_4__["IntroService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _views_categories_categories_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./views/categories/categories.component */
    "./src/app/views/categories/categories.component.ts");
    /* harmony import */
    ...
    var _dialog_edit_task_dialog_edit_task_dialog_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./dialog/edit-task-dialog/edit-task-dialog.component */
    ...
    var _dialog_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    ...
    var _pipe_task_date_pipe__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./pipe/task-date.pipe */
    ...
    var _angular_common_locales_ru__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! @angular/common/locales/ru */
    "./node_modules/@angular/common/locales/ru.js");
    /* harmony import */


    var _angular_common_locales_ru__WEBPACK_IMPORTED_MODULE_22___default = /*#__PURE__*/__webpack_require__.n(_angular_common_locales_ru__WEBPACK_IMPORTED_MODULE_22__);
    /* harmony import */
    ...
    var _dialog_edit_category_dialog_edit_category_dialog_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
    /*! ./dialog/edit-category-dialog/edit-category-dialog.component */
    "./src/app/dialog/edit-category-dialog/edit-category-dialog.component.ts");
    /* harmony import */


    var _views_stats_stats_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
    /*! ./views/stats/stats.component */
    "./src/app/views/stats/stats.component.ts");
    /* harmony import */


    var _views_header_header_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
    /*! ./views/header/header.component */
    "./src/app/views/header/header.component.ts");
    /* harmony import */


    var _views_stats_stats_card_stats_card_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
    /*! ./views/stats/stats-card/stats-card.component */
    "./src/app/views/stats/stats-card/stats-card.component.ts");
    /* harmony import */


    var ngx_color_picker__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
    /*! ngx-color-picker */
    "./node_modules/ngx-color-picker/__ivy_ngcc__/fesm2015/ngx-color-picker.js");
    /* harmony import */


    var _dialog_settings_dialog_settings_dialog_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
    /*! ./dialog/settings-dialog/settings-dialog.component */
    "./src/app/dialog/settings-dialog/settings-dialog.component.ts");
    /* harmony import */


    var _views_priorities_priorities_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
    /*! ./views/priorities/priorities.component */
    "./src/app/views/priorities/priorities.component.ts");
    /* harmony import */


    var _dialog_edit_priority_dialog_edit_priority_dialog_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
    /*! ./dialog/edit-priority-dialog/edit-priority-dialog.component */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_6__["MatTableModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_7__["MatSortModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_8__["MatPaginatorModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_10__["MatDialogModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_11__["MatFormFieldModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["FormsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_13__["MatInputModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_14__["MatButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_15__["MatIconModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_16__["MatOptionModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_17__["MatSelectModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_19__["MatDatepickerModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_16__["MatNativeDateModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_23__["MatCheckboxModule"], ngx_color_picker__WEBPACK_IMPORTED_MODULE_28__["ColorPickerModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _views_categories_categories_component__WEBPACK_IMPORTED_MODULE_3__["CategoriesComponent"], _views_tasks_tasks_component__WEBPACK_IMPORTED_MODULE_4__["TasksComponent"], _dialog_edit_task_dialog_edit_task_dialog_component__WEBPACK_IMPORTED_MODULE_9__["EditTaskDialogComponent"], _dialog_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_18__["ConfirmDialogComponent"], _pipe_task_date_pipe__WEBPACK_IMPORTED_MODULE_20__["TaskDatePipe"], _dialog_edit_category_dialog_edit_category_dialog_component__WEBPACK_IMPORTED_MODULE_24__["EditCategoryDialogComponent"], _views_stats_stats_component__WEBPACK_IMPORTED_MODULE_25__["StatsComponent"], _views_header_header_component__WEBPACK_IMPORTED_MODULE_26__["HeaderComponent"], _views_stats_stats_card_stats_card_component__WEBPACK_IMPORTED_MODULE_27__["StatsCardComponent"], _dialog_settings_dialog_settings_dialog_component__WEBPACK_IMPORTED_MODULE_29__["SettingsDialogComponent"], _views_priorities_priorities_component__WEBPACK_IMPORTED_MODULE_30__["PrioritiesComponent"], _dialog_edit_priority_dialog_edit_priority_dialog_component__WEBPACK_IMPORTED_MODULE_31__["EditPriorityDialogComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_6__["MatTableModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_7__["MatSortModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_8__["MatPaginatorModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_10__["MatDialogModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_11__["MatFormFieldModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["FormsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_13__["MatInputModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_14__["MatButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_15__["MatIconModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_16__["MatOptionModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_17__["MatSelectModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_19__["MatDatepickerModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_16__["MatNativeDateModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_23__["MatCheckboxModule"], ngx_color_picker__WEBPACK_IMPORTED_MODULE_28__["ColorPickerModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
          ...
          imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_6__["MatTableModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_7__["MatSortModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_8__["MatPaginatorModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_10__["MatDialogModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_11__["MatFormFieldModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["FormsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_13__["MatInputModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_14__["MatButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_15__["MatIconModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_16__["MatOptionModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_17__["MatSelectModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_19__["MatDatepickerModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_16__["MatNativeDateModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_23__["MatCheckboxModule"], ngx_color_picker__WEBPACK_IMPORTED_MODULE_28__["ColorPickerModule"]],
          providers: [],
          entryComponents: [_dialog_edit_task_dialog_edit_task_dialog_component__WEBPACK_IMPORTED_MODULE_9__["EditTaskDialogComponent"], _dialog_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_18__["ConfirmDialogComponent"], _dialog_edit_category_dialog_edit_category_dialog_component__WEBPACK_IMPORTED_MODULE_24__["EditCategoryDialogComponent"], _dialog_settings_dialog_settings_dialog_component__WEBPACK_IMPORTED_MODULE_29__["SettingsDialogComponent"], _dialog_edit_priority_dialog_edit_priority_dialog_component__WEBPACK_IMPORTED_MODULE_31__["EditPriorityDialogComponent"]],
          bootstrap: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"]]
        }]
      }], null, null);
    })();
  ...
  /***/
  function srcAppDataTestDataTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDataDaoImplementationCategoryDAOArrayTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CategoryDAOArray", function () {
    ...
    var _TestData__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../TestData */
    "./src/app/data/TestData.ts");

    var CategoryDAOArray = /*#__PURE__*/function () {
      function CategoryDAOArray() {
        _classCallCheck(this, CategoryDAOArray);
      }

      _createClass(CategoryDAOArray, [{
        key: "getAll",
        ...
        key: "getLastIdCategory",
        value: function getLastIdCategory() {
          return Math.max.apply(Math, _TestData__WEBPACK_IMPORTED_MODULE_1__["TestData"].categories.map(function (c) {
            return c.id;
          })) + 1;
        }
      }, {
        ...
        value: function _delete(id) {
          _TestData__WEBPACK_IMPORTED_MODULE_1__["TestData"].tasks.forEach(function (task) {
            if (task.category && task.category.id === id) {
              task.category = null;
            }
          });

          var categoriesTmp = _TestData__WEBPACK_IMPORTED_MODULE_1__["TestData"].categories.find(function (t) {
            return t.id === id;
          });
        ...
        value: function search(title) {
          return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["of"])(_TestData__WEBPACK_IMPORTED_MODULE_1__["TestData"].categories.filter(function (cat) {
            return cat.title.toUpperCase().includes(title.toUpperCase());
          }).sort(function (c1, c2) {
  ...
  /***/
  function srcAppDataDaoImplementationPriorityDAOArrayTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PriorityDAOArray", function () {
    ...
    var PriorityDAOArray = /*#__PURE__*/function () {
      function PriorityDAOArray() {
        _classCallCheck(this, PriorityDAOArray);
      }

      _createClass(PriorityDAOArray, [{
        key: "add",
        value: function add(priority) {
        ...
        key: "getLastIdTask",
        value: function getLastIdTask() {
          return Math.max.apply(Math, _TestData__WEBPACK_IMPORTED_MODULE_1__["TestData"].priorities.map(function (priority) {
            return priority.id;
          })) + 1;
        }
      }, {
        ...
        value: function _delete(id) {
          ...
          var prioritiesTmp = _TestData__WEBPACK_IMPORTED_MODULE_1__["TestData"].priorities.find(function (t) {
            return t.id === id;
          });
        ...
        key: "update",
        value: function update(priority) {
          var priorityTmp = _TestData__WEBPACK_IMPORTED_MODULE_1__["TestData"].priorities.find(function (p) {
  ...
  /***/
  function srcAppDataDaoImplementationTaskDAOArrayTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TaskDAOArray", function () {
      return TaskDAOArray;
    });
    /* harmony import */
    ...
    var TaskDAOArray = /*#__PURE__*/function () {
      function TaskDAOArray() {
        _classCallCheck(this, TaskDAOArray);
      }

      _createClass(TaskDAOArray, [{
        key: "getAll",
        value: function getAll() {
        ...
        key: "get",
        value: function get(id) {
          return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["of"])(_TestData__WEBPACK_IMPORTED_MODULE_1__["TestData"].tasks.find(function (todo) {
            return todo.id === id;
          }));
        }
      }, {
        ...
        key: "getLastIdTask",
        value: function getLastIdTask() {
          return Math.max.apply(Math, _TestData__WEBPACK_IMPORTED_MODULE_1__["TestData"].tasks.map(function (task) {
            return task.id;
          })) + 1;
        }
      }, {
        key: "delete",
        value: function _delete(id) {
          var taskTmp = _TestData__WEBPACK_IMPORTED_MODULE_1__["TestData"].tasks.find(function (t) {
            return t.id === id;
          });
        ...
        key: "getCompletedCountInCategory",
        value: function getCompletedCountInCategory(category) {
          return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["of"])(this.searchByElement(category, null, true, null).length);
        }
      }, {
        key: "getUncompletedCountInCategory",
        value: function getUncompletedCountInCategory(category) {
          return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["of"])(this.searchByElement(category, null, false, null).length);
        }
      }, {
        key: "getTotalCountInCategory",
        value: function getTotalCountInCategory(category) {
        ...
        key: "search",
        value: function search(category, searchText, status, priority) {
          return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["of"])(this.searchByElement(category, searchText, status, priority).reverse());
        }
      }, {
        key: "searchByElement",
        value: function searchByElement(category, searchText, status, priority) {
          var allTasks = _TestData__WEBPACK_IMPORTED_MODULE_1__["TestData"].tasks;
        ...
        key: "getTotalUncompletedCount",
        value: function getTotalUncompletedCount() {
          return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["of"])(_TestData__WEBPACK_IMPORTED_MODULE_1__["TestData"].tasks.filter(function (task) {
  ...
  /***/
  function srcAppDialogOperTypeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OperType", function () {
      return OperType;
    });
  ...
  /***/
  function srcAppDialogConfirmDialogConfirmDialogComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    ConfirmDialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 10,
      vars: 2,
      consts: [["mat-dialog-title", ""], ["mat-dialog-content", ""], ["mat-dialog-actions", ""], ["mat-raised-button", "", "color", "primary", 3, "click"], ["mat-button", "", 3, "click"]],
  ...
  /***/
  function srcAppDialogEditCategoryDialogEditCategoryDialogComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EditCategoryDialogComponent", function () {
    ...
    var _OperType__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../OperType */
    "./src/app/dialog/OperType.ts");
    /* harmony import */
    ...
    function EditCategoryDialogComponent_button_7_Template(rf, ctx) {
      if (rf & 1) {
        var _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 8);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditCategoryDialogComponent_button_7_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3);

          var ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r2.tmpTitle = "";
        });
    ...
    function EditCategoryDialogComponent_button_15_Template(rf, ctx) {
      if (rf & 1) {
        var _r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 9);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditCategoryDialogComponent_button_15_Template_button_click_0_listener() {
    ...
    var EditCategoryDialogComponent = /*#__PURE__*/function () {
      function EditCategoryDialogComponent(dialogRef, data, dialog) {
        _classCallCheck(this, EditCategoryDialogComponent);
      ...
      _createClass(EditCategoryDialogComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
        ...
        value: function _delete() {
          ...
          var dialogRef = this.dialog.open(_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_2__["ConfirmDialogComponent"], {
            maxWidth: '500px',
            data: {
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
              _this13.dialogRef.close('delete');
            }
          });
        }
      }, {
    ...
    EditCategoryDialogComponent.ɵfac = function EditCategoryDialogComponent_Factory(t) {
      return new (t || EditCategoryDialogComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialog"]));
    };

    EditCategoryDialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: EditCategoryDialogComponent,
      selectors: [["app-edit-category-dialog"]],
      decls: 16,
      vars: 5,
      consts: [["mat-dialog-title", ""], ["matInput", "", "maxlength", "15", 3, "ngModel", "ngModelChange", "keydown.enter"], ["mat-button", "", "matSuffix", "", "mat-icon-button", "", "aria-label", "Clear", "style", "font-size: 25px", 3, "click", 4, "ngIf"], [1, "col-md-8", "col-12"], ["mat-raised-button", "", "color", "primary", 3, "disabled", "click"], ["mat-raised-button", "", 3, "click"], [1, "col-md-4", "col-12", "text-right"], ["mat-button", "", "color", "warn", 3, "click", 4, "ngIf"], ["mat-button", "", "matSuffix", "", "mat-icon-button", "", "aria-label", "Clear", 2, "font-size", "25px", 3, "click"], ["mat-button", "", "color", "warn", 3, "click"]],
      template: function EditCategoryDialogComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditCategoryDialogComponent_Template_input_ngModelChange_6_listener($event) {
            return ctx.tmpTitle = $event;
          })("keydown.enter", function EditCategoryDialogComponent_Template_input_keydown_enter_6_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditCategoryDialogComponent_Template_button_click_10_listener() {
            return ctx.onConfirm();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditCategoryDialogComponent_Template_button_click_12_listener() {
            return ctx.onCancel();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EditCategoryDialogComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppDialogEditPriorityDialogEditPriorityDialogComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EditPriorityDialogComponent", function () {
    ...
    var _OperType__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../OperType */
    "./src/app/dialog/OperType.ts");
    /* harmony import */
    ...
    function EditPriorityDialogComponent_button_7_Template(rf, ctx) {
      if (rf & 1) {
        var _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 8);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditPriorityDialogComponent_button_7_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3);
    ...
    function EditPriorityDialogComponent_button_15_Template(rf, ctx) {
      if (rf & 1) {
        var _r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 9);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditPriorityDialogComponent_button_15_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);
    ...
    var EditPriorityDialogComponent = /*#__PURE__*/function () {
      function EditPriorityDialogComponent(dialogRef, data, dialog) {
        _classCallCheck(this, EditPriorityDialogComponent);
      ...
      _createClass(EditPriorityDialogComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.tmpTitle = this.data[0];
          this.dialogTitle = this.data[1];
        ...
        value: function _delete() {
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
              _this14.dialogRef.close('delete');
            }
          });
        }
      }, {
    ...
    EditPriorityDialogComponent.ɵfac = function EditPriorityDialogComponent_Factory(t) {
      return new (t || EditPriorityDialogComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialog"]));
    };

    EditPriorityDialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: EditPriorityDialogComponent,
      selectors: [["app-edit-priority-dialog"]],
      decls: 16,
      vars: 5,
      consts: [["mat-dialog-title", ""], ["matInput", "", "maxlength", "15", 3, "ngModel", "ngModelChange", "keydown.enter"], ["mat-button", "", "matSuffix", "", "mat-icon-button", "", "aria-label", "Clear", "style", "font-size: 25px", 3, "click", 4, "ngIf"], [1, "col-md-8", "col-12"], ["mat-raised-button", "", "color", "primary", 3, "disabled", "click"], ["mat-raised-button", "", 3, "click"], [1, "col-md-4", "col-12", "text-right"], ["mat-button", "", "color", "warn", 3, "click", 4, "ngIf"], ["mat-button", "", "matSuffix", "", "mat-icon-button", "", "aria-label", "Clear", 2, "font-size", "25px", 3, "click"], ["mat-button", "", "color", "warn", 3, "click"]],
      template: function EditPriorityDialogComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-dialog-content");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditPriorityDialogComponent_Template_input_ngModelChange_6_listener($event) {
            return ctx.tmpTitle = $event;
          })("keydown.enter", function EditPriorityDialogComponent_Template_input_keydown_enter_6_listener() {
            return ctx.tmpTitle.trim().length > 0 && ctx.onConfirm();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditPriorityDialogComponent_Template_button_click_10_listener() {
            return ctx.onConfirm();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditPriorityDialogComponent_Template_button_click_12_listener() {
            return ctx.onCancel();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EditPriorityDialogComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppDialogEditTaskDialogEditTaskDialogComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EditTaskDialogComponent", function () {
    ...
    var _service_data_handler_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../service/data-handler.service */
    "./src/app/service/data-handler.service.ts");
    /* harmony import */
    ...
    function EditTaskDialogComponent_button_7_Template(rf, ctx) {
      if (rf & 1) {
        var _r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 14);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditTaskDialogComponent_button_7_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8);

          var ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r7.tmpTitle = "";
        });
    ...
    function EditTaskDialogComponent_mat_option_14_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function EditTaskDialogComponent_mat_option_21_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-option", 4);
    ...
    function EditTaskDialogComponent_button_28_Template(rf, ctx) {
      if (rf & 1) {
        var _r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 14);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditTaskDialogComponent_button_28_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

          var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r11.tmpDate = null;
        });
    ...
    function EditTaskDialogComponent_div_35_button_1_Template(rf, ctx) {
      if (rf & 1) {
        var _r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 18);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditTaskDialogComponent_div_35_button_1_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16);

          var ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r15.complete();
        });
    ...
    function EditTaskDialogComponent_div_35_button_2_Template(rf, ctx) {
      if (rf & 1) {
        var _r18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 18);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditTaskDialogComponent_div_35_button_2_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r18);

          var ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r17.activate();
        });
    ...
    function EditTaskDialogComponent_div_35_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditTaskDialogComponent_div_35_Template_button_click_3_listener() {
    ...
    var EditTaskDialogComponent = /*#__PURE__*/function () {
      function EditTaskDialogComponent(dialogRef, data, dataHandler, dialog) {
        _classCallCheck(this, EditTaskDialogComponent);
      ...
      _createClass(EditTaskDialogComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this15 = this;
          ...
          this.dataHandler.getAllCategories().subscribe(function (items) {
            return _this15.categories = items;
          });
          this.dataHandler.getAllPriorities().subscribe(function (items) {
            return _this15.priorities = items;
          });
        }
      }, {
        key: "onConfirm",
        ...
        value: function _delete() {
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
              _this16.dialogRef.close('delete');
            }
          });
        }
      }, {
    ...
    EditTaskDialogComponent.ɵfac = function EditTaskDialogComponent_Factory(t) {
      return new (t || EditTaskDialogComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_data_handler_service__WEBPACK_IMPORTED_MODULE_4__["DataHandlerService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialog"]));
    };

    EditTaskDialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: EditTaskDialogComponent,
      selectors: [["app-edit-task-dialog"]],
      decls: 36,
      vars: 15,
      consts: [["mat-dialog-title", ""], ["matInput", "", 3, "ngModel", "ngModelChange", "keydown.enter"], ["mat-button", "", "matSuffix", "", "mat-icon-button", "", "aria-label", "Clear", "style", "font-size: 25px", 3, "click", 4, "ngIf"], [3, "ngModel", "ngModelChange"], [3, "value"], [3, "value", 4, "ngFor", "ngForOf"], ["matInput", "", "placeholder", "\u0423\u043A\u0430\u0436\u0438\u0442\u0435 \u0441\u0440\u043E\u043A \u0432\u044B\u043F\u043E\u043B\u043D\u0435\u043D\u0438\u044F", "readonly", "true", 3, "matDatepicker", "ngModel", "ngModelChange", "click"], ["inputDate", ""], ["matSuffix", "", 3, "for"], ["picker", ""], [1, "col-md-5", "col-12"], ["mat-raised-button", "", "color", "primary", 3, "disabled", "click"], ["mat-raised-button", "", 3, "click"], ["class", "col-md-7 col-12 text-right", 4, "ngIf"], ["mat-button", "", "matSuffix", "", "mat-icon-button", "", "aria-label", "Clear", 2, "font-size", "25px", 3, "click"], [1, "col-md-7", "col-12", "text-right"], ["mat-button", "", 3, "click", 4, "ngIf"], ["mat-button", "", "color", "warn", 3, "click"], ["mat-button", "", 3, "click"]],
      template: function EditTaskDialogComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditTaskDialogComponent_Template_input_ngModelChange_6_listener($event) {
            return ctx.tmpTitle = $event;
          })("keydown.enter", function EditTaskDialogComponent_Template_input_keydown_enter_6_listener() {
            return ctx.tmpTitle.trim().length > 0 && ctx.onConfirm();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditTaskDialogComponent_Template_mat_select_ngModelChange_11_listener($event) {
            return ctx.tmpCategory = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditTaskDialogComponent_Template_mat_select_ngModelChange_18_listener($event) {
            return ctx.tmpPriority = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditTaskDialogComponent_Template_input_ngModelChange_23_listener($event) {
            return ctx.tmpDate = $event;
          })("click", function EditTaskDialogComponent_Template_input_click_23_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditTaskDialogComponent_Template_button_click_31_listener() {
            return ctx.onConfirm();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditTaskDialogComponent_Template_button_click_33_listener() {
            return ctx.onCancel();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EditTaskDialogComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppDialogSettingsDialogSettingsDialogComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SettingsDialogComponent", function () {
    ...
    var _service_data_handler_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../service/data-handler.service */
    "./src/app/service/data-handler.service.ts");
    /* harmony import */


    var _views_priorities_priorities_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../views/priorities/priorities.component */
    "./src/app/views/priorities/priorities.component.ts");
    /* harmony import */
    ...
    var SettingsDialogComponent = /*#__PURE__*/function () {
      function SettingsDialogComponent(dialogRef, dataHandler) {
        _classCallCheck(this, SettingsDialogComponent);

        this.dialogRef = dialogRef;
        this.dataHandler = dataHandler;
      }

      _createClass(SettingsDialogComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this17 = this;

          this.dataHandler.getAllPriorities().subscribe(function (priorities) {
            return _this17.priorities = priorities;
          });
        }
      }, {
        key: "onClose",
        ...
        key: "onDeletePriority",
        value: function onDeletePriority(priority) {
          this.dataHandler.deletePriority(priority.id).subscribe(function () {});
        }
      }, {
        key: "onAddPriority",
        value: function onAddPriority(priority) {
          this.dataHandler.addPriority(priority).subscribe();
        }
      }, {
        key: "onUpdatePriority",
        value: function onUpdatePriority(priority) {
    ...
    SettingsDialogComponent.ɵfac = function SettingsDialogComponent_Factory(t) {
      return new (t || SettingsDialogComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_data_handler_service__WEBPACK_IMPORTED_MODULE_2__["DataHandlerService"]));
    };

    SettingsDialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: SettingsDialogComponent,
      selectors: [["app-settings-dialog"]],
      decls: 7,
      vars: 1,
      consts: [["mat-dialog-title", "", 1, "settings-title", "with-subtitle"], [3, "priorities", "deletePriority", "addPriority", "updatePriority"], ["color", "primary", "mat-raised-button", "", 3, "click"]],
      template: function SettingsDialogComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("deletePriority", function SettingsDialogComponent_Template_app_priorities_deletePriority_3_listener($event) {
            return ctx.onDeletePriority($event);
          })("addPriority", function SettingsDialogComponent_Template_app_priorities_addPriority_3_listener($event) {
            return ctx.onAddPriority($event);
          })("updatePriority", function SettingsDialogComponent_Template_app_priorities_updatePriority_3_listener($event) {
            return ctx.onUpdatePriority($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SettingsDialogComponent_Template_button_click_5_listener() {
            return ctx.onClose();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SettingsDialogComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModelCategoryTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Category = function Category(id, title) {
  ...
  /***/
  function srcAppModelPriorityTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Priority = function Priority(id, title, color) {
  ...
  /***/
  function srcAppModelTaskTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Task = function Task(id, title, completed, priority, category, date) {
  ...
  /***/
  function srcAppPipeTaskDatePipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TaskDatePipe", function () {
      return TaskDatePipe;
    });
    /* harmony import */
    ...
    var TaskDatePipe = /*#__PURE__*/function (_angular_common__WEBP) {
      _inherits(TaskDatePipe, _angular_common__WEBP);

      var _super = _createSuper(TaskDatePipe);

      function TaskDatePipe() {
        _classCallCheck(this, TaskDatePipe);

        return _super.apply(this, arguments);
      }

      _createClass(TaskDatePipe, [{
        key: "transform",
    ...
    TaskDatePipe.ɵfac = function TaskDatePipe_Factory(t) {
      return ɵTaskDatePipe_BaseFactory(t || TaskDatePipe);
    };

    TaskDatePipe.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({
      name: "taskDate",
      type: TaskDatePipe,
      pure: true
    });

    var ɵTaskDatePipe_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetInheritedFactory"](TaskDatePipe);
    /*@__PURE__*/


    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TaskDatePipe, [{
  ...
  /***/
  function srcAppServiceDataHandlerServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _data_dao_implementation_TaskDAOArray__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../data/dao/implementation/TaskDAOArray */
    "./src/app/data/dao/implementation/TaskDAOArray.ts");
    /* harmony import */


    var _data_dao_implementation_CategoryDAOArray__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../data/dao/implementation/CategoryDAOArray */
    "./src/app/data/dao/implementation/CategoryDAOArray.ts");
    /* harmony import */


    var _data_dao_implementation_PriorityDAOArray__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../data/dao/implementation/PriorityDAOArray */
    "./src/app/data/dao/implementation/PriorityDAOArray.ts");
    ...
    var DataHandlerService = /*#__PURE__*/function () {
      ...
      */
      ...
      _createClass(DataHandlerService, [{
        ...
        key: "getAllPriorities",
        value: function getAllPriorities() {
          return this.priorityDAOArray.getAll();
        }
      }, {
        key: "searchTasks",
        value: function searchTasks(category, searchText, status, priority) {
        ...
        key: "addCategory",
        value: function addCategory(title) {
        ...
        value: function searchCategories(title) {
          return this.categoryDaoArray.search(title);
        }
      }, {
        key: "getCompletedTasksCountInCategory",
        value: function getCompletedTasksCountInCategory(category) {
          return this.taskDaoArray.getCompletedCountInCategory(category);
        }
      }, {
        key: "getUncompletedTotalCount",
        value: function getUncompletedTotalCount() {
          return this.taskDaoArray.getTotalUncompletedCount();
        }
      }, {
        key: "getUncompletedTasksCountInCategory",
        value: function getUncompletedTasksCountInCategory(category) {
        ...
        key: "deletePriority",
        value: function deletePriority(id) {
          return this.priorityDAOArray["delete"](id);
        }
      }, {
        key: "addPriority",
        value: function addPriority(priority) {
          return this.priorityDAOArray.add(priority);
        }
      }, {
        key: "updatePriority",
        value: function updatePriority(priority) {
    ...
    DataHandlerService.ɵfac = function DataHandlerService_Factory(t) {
      return new (t || DataHandlerService)();
    };

    DataHandlerService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DataHandlerService, [{
  ...
  /***/
  function srcAppServiceIntroServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var intro_js_intro__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! intro.js/intro */
    "./node_modules/intro.js/intro.js");
    /* harmony import */


    var intro_js_intro__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(intro_js_intro__WEBPACK_IMPORTED_MODULE_1__);
    ...
    IntroService.ɵfac = function IntroService_Factory(t) {
      return new (t || IntroService)();
    };

    IntroService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: IntroService,
      factory: IntroService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](IntroService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
  ...
  function srcAppViewsCategoriesCategoriesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _dialog_edit_category_dialog_edit_category_dialog_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../dialog/edit-category-dialog/edit-category-dialog.component */
    "./src/app/dialog/edit-category-dialog/edit-category-dialog.component.ts");
    /* harmony import */


    var _dialog_OperType__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../dialog/OperType */
    "./src/app/dialog/OperType.ts");
    /* harmony import */
    ...
    function CategoriesComponent_button_13_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CategoriesComponent_button_13_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);

          var ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          ctx_r4.searchCategoryTitle = "";
    ...
    function CategoriesComponent_div_23_li_1_mat_icon_5_Template(rf, ctx) {
      if (rf & 1) {
        var _r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-icon", 25);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CategoriesComponent_div_23_li_1_mat_icon_5_Template_mat_icon_click_0_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);

          var mapValue_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;

          var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          $event.stopPropagation();
          return ctx_r10.openEditCategoryDialog(mapValue_r7.key);
        });
    ...
    function CategoriesComponent_div_23_li_1_Template(rf, ctx) {
      if (rf & 1) {
        var _r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "li", 20);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CategoriesComponent_div_23_li_1_Template_li_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14);

          var mapValue_r7 = ctx.$implicit;

          var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r13.showTasksByCategory(mapValue_r7.key);
        })("mouseleave", function CategoriesComponent_div_23_li_1_Template_li_mouseleave_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14);

          var ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r15.showEditIcon(null);
        })("mouseenter", function CategoriesComponent_div_23_li_1_Template_li_mouseenter_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14);
          ...
          return ctx_r16.showEditIcon(index_r8);
        });
    ...
    var CategoriesComponent = /*#__PURE__*/function () {
      ...
      _createClass(CategoriesComponent, [{
        ...
        key: "showTasksByCategory",
        value: function showTasksByCategory(category) {
        ...
        key: "showEditIcon",
        value: function showEditIcon(index) {
          this.indexMouseMove = index;
        }
      }, {
        key: "openEditCategoryDialog",
        value: function openEditCategoryDialog(category) {
          var _this18 = this;
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            if (result === 'delete') {
              _this18.deleteCategory.emit(category);
            ...
            if (typeof result === 'string') {
              ...
              _this18.updateCategory.emit(category);
        ...
        value: function openAddCategoryDialog() {
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
              _this19.addCategory.emit(result);
    ...
    CategoriesComponent.ɵfac = function CategoriesComponent_Factory(t) {
      return new (t || CategoriesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_data_handler_service__WEBPACK_IMPORTED_MODULE_3__["DataHandlerService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"]));
    };
    ...
    CategoriesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      inputs: {
        ...
        setCategoryMap: ["categoryMap", "setCategoryMap"]
      },
      outputs: {
      ...
      template: function CategoriesComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CategoriesComponent_Template_button_click_5_listener() {
            return ctx.openAddCategoryDialog();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keydown.escape", function CategoriesComponent_Template_input_keydown_escape_11_listener() {
            ctx.searchCategoryTitle = "";
            return ctx.search();
          })("keyup", function CategoriesComponent_Template_input_keyup_11_listener() {
            return ctx.search();
          })("ngModelChange", function CategoriesComponent_Template_input_ngModelChange_11_listener($event) {
            return ctx.searchCategoryTitle = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CategoriesComponent_Template_li_click_14_listener() {
            return ctx.showTasksByCategory(null);
          });
  ...
  function srcAppViewsHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _dialog_settings_dialog_settings_dialog_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../dialog/settings-dialog/settings-dialog.component */
    "./src/app/dialog/settings-dialog/settings-dialog.component.ts");
    /* harmony import */
    ...
    var _service_intro_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../service/intro.service */
    "./src/app/service/intro.service.ts");
    /* harmony import */
    ...
    function HeaderComponent_p_5_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_p_5_Template_p_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3);

          var ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r2.onToggleStat();
        });
    ...
    function HeaderComponent_p_6_Template(rf, ctx) {
      if (rf & 1) {
        var _r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p", 8);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_p_6_Template_p_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);

          var ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r4.onToggleStat();
        });
    ...
    var HeaderComponent = /*#__PURE__*/function () {
      ...
      _createClass(HeaderComponent, [{
        ...
        key: "onToggleStat",
        value: function onToggleStat() {
          this.toggleStat.emit(this.showStat);
        }
      }, {
        key: "showSettings",
        value: function showSettings() {
          var dialogRef = this.dialog.open(_dialog_settings_dialog_settings_dialog_component__WEBPACK_IMPORTED_MODULE_1__["SettingsDialogComponent"], {
            autoFocus: false,
            width: '500px'
          });
        }
    ...
    HeaderComponent.ɵfac = function HeaderComponent_Factory(t) {
      return new (t || HeaderComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_intro_service__WEBPACK_IMPORTED_MODULE_3__["IntroService"]));
    };
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 14,
      vars: 3,
      consts: [[1, "container-fluid"], [1, "row", "settings"], [1, "col-10", "text-left", "align-self-top"], [1, "navbar-brand"], ["class", "navbar-brand link", 3, "click", 4, "ngIf"], [1, "col-2", "text-right", "align-self-top"], ["mat-icon-button", "", "data-intro", "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0430 \u043F\u0440\u0438\u043E\u0440\u0438\u0435\u0442\u043E\u0432", "data-position", "top", "data-step", "4", 3, "click"], ["mat-icon-button", "", 1, "header-icon", 3, "click"], [1, "navbar-brand", "link", 3, "click"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _angular_material_button__WEBPACK_IMPORTED_MODULE_5__["MatButton"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIcon"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HeaderComponent, [{
        ...
        return [{
          ...
          type: _service_intro_service__WEBPACK_IMPORTED_MODULE_3__["IntroService"]
        }];
      }, {
        categoryName: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
  ...
  /***/
  function srcAppViewsPrioritiesPrioritiesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PrioritiesComponent", function () {
    ...
    var _model_Priority__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../model/Priority */
    "./src/app/model/Priority.ts");
    /* harmony import */
    ...
    var _dialog_edit_priority_dialog_edit_priority_dialog_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../dialog/edit-priority-dialog/edit-priority-dialog.component */
    "./src/app/dialog/edit-priority-dialog/edit-priority-dialog.component.ts");
    /* harmony import */


    var _dialog_OperType__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../dialog/OperType */
    "./src/app/dialog/OperType.ts");
    /* harmony import */
    ...
    function PrioritiesComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PrioritiesComponent_div_0_Template_a_click_3_listener() {
          ...
          return ctx_r3.onEditPriority(priority_r1);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("colorPickerChange", function PrioritiesComponent_div_0_Template_span_colorPickerChange_6_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);

          var priority_r1 = ctx.$implicit;
          return priority_r1.color = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PrioritiesComponent_div_0_Template_p_click_8_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);
          ...
          return ctx_r6.onEditPriority(priority_r1);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PrioritiesComponent_div_0_Template_p_click_12_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);
          ...
          return ctx_r7["delete"](priority_r1);
        });
    ...
    var PrioritiesComponent = /*#__PURE__*/function () {
      function PrioritiesComponent(dialog) {
        _classCallCheck(this, PrioritiesComponent);
      ...
      _createClass(PrioritiesComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "delete",
        value: function _delete(priority) {
          var _this20 = this;
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
              _this20.deletePriority.emit(priority);
            }
          });
        }
      }, {
        key: "onEditPriority",
        value: function onEditPriority(priority) {
          var _this21 = this;

          var dialogRef = this.dialog.open(_dialog_edit_priority_dialog_edit_priority_dialog_component__WEBPACK_IMPORTED_MODULE_3__["EditPriorityDialogComponent"], {
            data: [priority.title, 'Редактирование приоритета', _dialog_OperType__WEBPACK_IMPORTED_MODULE_4__["OperType"].EDIT]
          });
          dialogRef.afterClosed().subscribe(function (result) {
            if (result === 'delete') {
              _this21.deletePriority.emit(priority);
            }

            if (result) {
              priority.title = result;

              _this21.updatePriority.emit(priority);
        ...
        value: function onAddPriority() {
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
              var newPriority = new _model_Priority__WEBPACK_IMPORTED_MODULE_1__["Priority"](null, result, PrioritiesComponent.defaultColor);

              _this22.addPriority.emit(newPriority);
            }
          });
        }
      }]);
    ...
    PrioritiesComponent.ɵfac = function PrioritiesComponent_Factory(t) {
      return new (t || PrioritiesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__["MatDialog"]));
    };

    PrioritiesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: PrioritiesComponent,
      selectors: [["app-priorities"]],
      inputs: {
      ...
      decls: 3,
      vars: 1,
      consts: [["class", "vertical-middle priorities", 4, "ngFor", "ngForOf"], [1, "link", "little", 3, "click"], [1, "vertical-middle", "priorities"], [1, "row", "align-self-baseline"], [1, "col-7"], [1, "pointer", 3, "click"], [1, "col-2", "text-right"], [1, "color-circle", 3, "colorPicker", "colorPickerChange"], [1, "col-1", "text-left"], [1, "pointer", "gray", 3, "click"]],
      template: function PrioritiesComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, PrioritiesComponent_div_0_Template, 15, 4, "div", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "p", 1);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PrioritiesComponent_Template_p_click_1_listener() {
            return ctx.onAddPriority();
          });
  ...
  /***/
  function srcAppViewsStatsStatsCardStatsCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StatsCardComponent", function () {
    ...
    function StatsCardComponent_span_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var StatsCardComponent = /*#__PURE__*/function () {
      function StatsCardComponent() {
        _classCallCheck(this, StatsCardComponent);
      }

      _createClass(StatsCardComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    StatsCardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 13,
      vars: 4,
      consts: [[1, "card", "card-stats"], [1, "card-header", "card-header-primary", "card-header-icon"], [1, "card-icon"], [1, "material-icons"], [1, "card-category"], [1, "card-title"], [4, "ngIf"], [1, "card-footer"], [1, "stats"], [1, "stat-card-title"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StatsCardComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppViewsStatsStatsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _stats_card_stats_card_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    StatsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      inputs: {
        ...
        completedTasksInCategory: "completedTasksInCategory",
        uncompletedTasksInCategory: "uncompletedTasksInCategory",
        showStat: "showStat"
      },
      decls: 1,
      vars: 1,
      consts: [[4, "ngIf"], [1, "row"], ["iconName", "done", "title", "\u0417\u0430\u0432\u0435\u0440\u0448\u0435\u043D\u043D\u044B\u0435 \u0437\u0430\u0434\u0430\u0447\u0438", 1, "col-lg-3", "col-md-6", "col-sm-6", 3, "count", "countTotal"], ["iconName", "thumb_down_alt", "title", "\u041D\u0435\u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043D\u043D\u044B\u0435 \u0437\u0430\u0434\u0430\u0447\u0438", 1, "col-lg-3", "col-md-6", "col-sm-6", 3, "count", "countTotal"], ["iconName", "poll", "title", "\u041F\u0440\u043E\u0446\u0435\u043D\u0442 \u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043D\u043D\u044B\u0445 \u0437\u0430\u0434\u0430\u0447", 1, "col-lg-3", "col-md-6", "col-sm-6", "completed-card", 3, "count"], ["iconName", "thumb_down_alt", "title", "\u041F\u0440\u043E\u0446\u0435\u043D\u0442 \u043D\u0435\u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043D\u043D\u044B\u0445 \u0437\u0430\u0434\u0430\u0447", 1, "col-lg-3", "col-md-6", "col-sm-6", 3, "count"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["NgIf"], _stats_card_stats_card_component__WEBPACK_IMPORTED_MODULE_2__["StatsCardComponent"]],
  ...
  function srcAppViewsTasksTasksComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_model_Task__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/model/Task */
    "./src/app/model/Task.ts");
    /* harmony import */
    ...
    var _dialog_edit_task_dialog_edit_task_dialog_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../dialog/edit-task-dialog/edit-task-dialog.component */
    "./src/app/dialog/edit-task-dialog/edit-task-dialog.component.ts");
    /* harmony import */


    var _dialog_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../dialog/confirm-dialog/confirm-dialog.component */
    "./src/app/dialog/confirm-dialog/confirm-dialog.component.ts");
    /* harmony import */


    var _dialog_OperType__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../dialog/OperType */
    "./src/app/dialog/OperType.ts");
    /* harmony import */


    var _service_data_handler_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../../service/data-handler.service */
    "./src/app/service/data-handler.service.ts");
    /* harmony import */
    ...
    var _pipe_task_date_pipe__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ../../pipe/task-date.pipe */
    "./src/app/pipe/task-date.pipe.ts");

    function TasksComponent_button_5_Template(rf, ctx) {
      if (rf & 1) {
        var _r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 20);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TasksComponent_button_5_Template_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10);

          var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          ctx_r9.searchTaskText = "";
          return ctx_r9.onFilterByTitle();
        });
    ...
    function TasksComponent_button_16_Template(rf, ctx) {
      if (rf & 1) {
        var _r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 20);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TasksComponent_button_16_Template_button_click_0_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

          var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          $event.stopPropagation();
          return ctx_r11.onFilterByStatus(null);
        });
    ...
    function TasksComponent_mat_option_22_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TasksComponent_button_23_Template(rf, ctx) {
      if (rf & 1) {
        var _r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 20);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TasksComponent_button_23_Template_button_click_0_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r15);

          var ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          $event.stopPropagation();
          return ctx_r14.onFilterByPriority(null);
        });
    ...
    function TasksComponent_button_27_Template(rf, ctx) {
      if (rf & 1) {
        var _r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 21);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TasksComponent_button_27_Template_button_click_0_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r17);

          var ctx_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          $event.stopPropagation();
          ctx_r16.onFilterByStatus(null);
          ctx_r16.onFilterByPriority(null);
          ctx_r16.searchTaskText = "";
          return ctx_r16.onFilterByTitle();
        });
    ...
    function TasksComponent_div_36_th_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "th", 45);
      }
    }

    function TasksComponent_div_36_td_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TasksComponent_div_36_th_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "th", 45);
      }
    }

    function TasksComponent_div_36_td_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TasksComponent_div_36_th_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TasksComponent_div_36_td_10_Template(rf, ctx) {
      if (rf & 1) {
        var _r40 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 49);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TasksComponent_div_36_td_10_Template_td_click_0_listener() {
          ...
          return ctx_r39.openEditTaskDialog(task_r38);
        });
    ...
    function TasksComponent_div_36_th_12_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 48);
    ...
    function TasksComponent_div_36_td_13_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TasksComponent_div_36_th_15_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 48);
    ...
    function TasksComponent_div_36_td_16_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TasksComponent_div_36_th_18_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 48);
    ...
    function TasksComponent_div_36_td_19_Template(rf, ctx) {
      if (rf & 1) {
        var _r45 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 52);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TasksComponent_div_36_td_19_Template_td_click_0_listener() {
          ...
          return !task_r43.completed && task_r43.category && ctx_r44.onSelectCategory(task_r43.category);
        });
    ...
    function TasksComponent_div_36_th_21_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "th", 45);
      }
    }

    function TasksComponent_div_36_td_22_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TasksComponent_div_36_td_22_Template_button_click_1_listener() {
          ...
          return ctx_r47.openDeleteDialog(task_r46);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TasksComponent_div_36_td_22_Template_button_click_4_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r48);
          ...
          return ctx_r49.openEditTaskDialog(task_r46);
        });
    ...
    function TasksComponent_div_36_th_24_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "th", 45);
      }
    }

    function TasksComponent_div_36_td_25_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TasksComponent_div_36_td_25_Template_mat_checkbox_click_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r52);

          return $event.stopPropagation();
        })("change", function TasksComponent_div_36_td_25_Template_mat_checkbox_change_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r52);
          ...
          return $event ? ctx_r53.onToggleStatus(task_r50) : null;
        });
    ...
    function TasksComponent_div_36_tr_26_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", 59);
      }
    }

    function TasksComponent_div_36_tr_27_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var TasksComponent = /*#__PURE__*/function () {
      ...
      _createClass(TasksComponent, [{
        ...
        value: function getPriorityColor(task) {
          if (task.completed) {
            return '#F8F9FA';
          }
        ...
        key: "addTableObjects",
        value: function addTableObjects() {
          this.dataSource.sort = this.sort;
          this.dataSource.paginator = this.paginator;
        }
      }, {
        key: "openEditTaskDialog",
        value: function openEditTaskDialog(task) {
          var _this23 = this;

          var dialogRef = this.dialog.open(_dialog_edit_task_dialog_edit_task_dialog_component__WEBPACK_IMPORTED_MODULE_5__["EditTaskDialogComponent"], {
            data: [task, 'Редактирование задачи', _dialog_OperType__WEBPACK_IMPORTED_MODULE_7__["OperType"].EDIT],
            autoFocus: false
          });
          dialogRef.afterClosed().subscribe(function (result) {
            if (result === 'delete') {
              _this23.deleteTask.emit(task);
        ...
        value: function openDeleteDialog(task) {
          var _this24 = this;
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
              _this24.deleteTask.emit(task);
            }
          });
        }
      }, {
        key: "onToggleStatus",
        value: function onToggleStatus(task) {
        ...
        key: "onFilterByTitle",
        value: function onFilterByTitle() {
          this.filterByTitle.emit(this.searchTaskText);
        }
      }, {
        key: "onFilterByStatus",
        value: function onFilterByStatus(value) {
        ...
        key: "onFilterByPriority",
        value: function onFilterByPriority(value) {
        ...
        key: "openAddTaskDialog",
        value: function openAddTaskDialog() {
          var _this25 = this;

          var task = new src_app_model_Task__WEBPACK_IMPORTED_MODULE_1__["Task"](null, '', false, null, this.selectedCategory);
          var dialogRef = this.dialog.open(_dialog_edit_task_dialog_edit_task_dialog_component__WEBPACK_IMPORTED_MODULE_5__["EditTaskDialogComponent"], {
            data: [task, 'Добавление задачи', _dialog_OperType__WEBPACK_IMPORTED_MODULE_7__["OperType"].ADD]
          });
          dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
              _this25.addTask.emit(task);
            }
          });
        }
      }, {
    ...
    TasksComponent.ɵfac = function TasksComponent_Factory(t) {
      return new (t || TasksComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_data_handler_service__WEBPACK_IMPORTED_MODULE_8__["DataHandlerService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_9__["MatDialog"]));
    };
    ...
    TasksComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      inputs: {
        ...
        setPriorities: ["priorities", "setPriorities"],
        selectedCategory: "selectedCategory"
      },
      outputs: {
      ...
      template: function TasksComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keydown.escape", function TasksComponent_Template_input_keydown_escape_3_listener() {
            ctx.searchTaskText = "";
            return ctx.onFilterByTitle();
          })("keyup", function TasksComponent_Template_input_keyup_3_listener() {
            return ctx.onFilterByTitle();
          })("ngModelChange", function TasksComponent_Template_input_ngModelChange_3_listener($event) {
            return ctx.searchTaskText = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function TasksComponent_Template_mat_select_valueChange_8_listener($event) {
            return ctx.onFilterByStatus($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function TasksComponent_Template_mat_select_valueChange_19_listener($event) {
            return ctx.onFilterByPriority($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TasksComponent_Template_button_click_29_listener() {
      ...
      pipes: [_pipe_task_date_pipe__WEBPACK_IMPORTED_MODULE_19__["TaskDatePipe"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Oleshka\Desktop\my-plan\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
